    ...
    <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div className="sm:col-span-2">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-2.5">
            <input type="email" name="email" id="email" autocomplete="email" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-700 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        <div className="sm:col-span-2">
      ...
      <div className="mt-10">
        <button type="submit" className="block w-full rounded-md  px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">Let's talk</button>
      </div>
    </form>
  </div>
  )
